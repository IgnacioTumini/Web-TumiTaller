...
var createAppointments_service_1 = require("../../services/appointments/createAppointments.service");
var createAppointment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, date, time, userId, newAppointment, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, createAppointments_service_1.createAppointmentService)(date, time, userId)];
            case 2:
